...
def cli():
    ...
    if vad_input is not None:
        ...
        vad_pipeline = Pipeline.from_pretrained("pyannote/voice-activity-detection",use_auth_token="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")

    diarize_pipeline = None
    if diarize:
        from pyannote.audio import Pipeline
        diarize_pipeline = Pipeline.from_pretrained("pyannote/speaker-diarization@2.1",use_auth_token="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")
